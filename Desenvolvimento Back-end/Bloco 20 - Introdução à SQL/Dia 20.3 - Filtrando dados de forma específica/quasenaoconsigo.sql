...
-- Utilize a coluna rental_date para extrair as informações. RESOLVER
SELECT * FROM sakila.rental;


-- Monte uma query que retorne todos os dados do pagamento feito no dia 28/07/2005 a partir das 22 horas . RESOLVER
SELECT * FROM sakila.payment WHERE payment_date LIKE '2005-07-28 22:00:00';
