...
SELECT * FROM Fornecimentos WHERE peca LIKE 2 ORDER BY Fornecedor;
-- Escreva uma query para exibir as peças, preço e fornecedor de todos os fornecimentos em que o 
...
SELECT * FROM Fornecedores WHERE name LIKE '%LTDA%' ORDER BY name;
