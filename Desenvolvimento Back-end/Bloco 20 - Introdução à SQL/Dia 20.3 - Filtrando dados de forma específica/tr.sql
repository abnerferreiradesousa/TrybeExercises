...
-- baixo, entre os filmes feitos para menores de idade e que têm o custo mínimo de substituição 
-- de $18,00 dólares. Em caso de empate, ordene em ordem alfabética pelo título. As informações 
-- podem ser encontradas na tabela film
...
-- Mostre todos os detalhes dos clientes que não estão ativos na loja 1 . As informações podem ser 
