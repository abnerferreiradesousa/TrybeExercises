...
-- fails (`Pixar`.`BoxOffice`, CONSTRAINT `BoxOffice_ibfk_1` FOREIGN KEY (`movie_id`) REFERENCES `Movies` (`id`))
...
-- fez 450 milhões no mercado interno e 370 milhões no mercado internacional. Adicione 
-- as informações à tabela BoxOffice .
